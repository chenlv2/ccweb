...
public class ElasticsearchUtil {
     ...
     * @return
     */
    public static <T> String addData(T jsonObject, String index, String type, String id) {
     ...
     * @return
     */
    public static <T> String addData(T jsonObject, String index, String type) {
     ...
     * @return
     */
    public static <T> void updateDataById(T jsonObject, String index, String type, String id) {
     ...
     * @return
     */
    public static ResponseData searchData(String index, String type, int startPage, int pageSize, QueryBuilder query, String fields, String sortField, String highlightField) {
        ...
        if (searchResponse.status().getStatus() == 200) {
            ...
            pageInfo.setPageIndex(startPage);
            pageInfo.setPageCount(pageSize);
            pageInfo.setTotalRecords(totalHits);

            ResponseData responseData = new ResponseData();
            responseData.setPageInfo(pageInfo);
            responseData.setData(sourceList);
