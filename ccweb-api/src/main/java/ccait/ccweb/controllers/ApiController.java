...
public class ApiController extends BaseController {
    ...
    public ResponseData doJoinQuery(@PathVariable String table1, String table2, @RequestBody QueryInfo queryInfo) {
    ...
    public ResponseData doLeftQuery(@PathVariable String table1, String table2, @RequestBody QueryInfo queryInfo) {
    ...
    public ResponseData doRightQuery(@PathVariable String table1, String table2, @RequestBody QueryInfo queryInfo) {
